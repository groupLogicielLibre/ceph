...
epoches after it with the crush map in the found epoch if asked to do so. By
default, print out the crush map in the good osdmap epoch.


$0 [options] ...
  [-h|--help]            display this message
  [--mon-store]          monitor storage path of the leader
...
function main() {
    ...
    if ! test $store_path; then
        echo "I need the path to mon-store."
        return 1
    fi
